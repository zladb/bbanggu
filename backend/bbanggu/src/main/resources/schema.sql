...
-- 순환참조문제로 인해 FK 삭제 후 드롭
SET FOREIGN_KEY_CHECKS=0;
SELECT CONCAT('ALTER TABLE ', TABLE_NAME, ' DROP FOREIGN KEY ', CONSTRAINT_NAME, ';')
FROM INFORMATION_SCHEMA.KEY_COLUMN_USAGE
WHERE REFERENCED_TABLE_SCHEMA = 'bbanggu';
DROP TABLE IF EXISTS bakery_pickup_timetable;
DROP TABLE IF EXISTS settlement;
DROP TABLE IF EXISTS bread_category;
DROP TABLE IF EXISTS stock;
DROP TABLE IF EXISTS review;
DROP TABLE IF EXISTS favorite;
DROP TABLE IF EXISTS echo_saving;
DROP TABLE IF EXISTS reservation;
DROP TABLE IF EXISTS bread_package;
...
ALTER TABLE bread AUTO_INCREMENT = 1;
ALTER TABLE stock AUTO_INCREMENT = 1;
ALTER TABLE user AUTO_INCREMENT = 1;
ALTER TABLE bread_category AUTO_INCREMENT = 1;
ALTER TABLE bread_package AUTO_INCREMENT = 1;
ALTER TABLE bakery AUTO_INCREMENT = 1;
ALTER TABLE echo_saving AUTO_INCREMENT = 1;
