      ...
      <div className="flex-1 px-5">
        ...
        <div className="mb-6">
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            >
              <img src="/icons/payment/naverpay.png" alt="네이버페이" className="h-5" />
            </button>
            <button 
              className={`border rounded-xl p-4 flex flex-col items-center justify-center ${
            ...
            >
              <img src="/icons/payment/kakaopay.png" alt="카카오페이" className="h-10" />
            </button>
            <button 
              className={`border rounded-xl p-4 flex flex-col items-center justify-center ${
            ...
            >
              <img src="/icons/payment/tosspay.png" alt="토스페이" className="h-11" />
            </button>
          </div>
        </div>
