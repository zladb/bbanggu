...
export function UserSaveReport() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* 총 절약 금액 */}
      <div className="bg-whtie text-center pt-12 mx">
        <div className="w-[120px] h-[120px] bg-[#FC973B] rounded-full mx-auto mb-4 flex items-center justify-center">
          <img src="/src/assets/pig.png" alt="절약 금액" className="w-16 h-16" />
        </div>
      ...
      {/* 절약 상세 정보 */}
      <div className="px-5 pt-10 grid grid-cols-2 gap-4">
        <div className="bg-[#F9F9F9] rounded-xl py-8 shadow-md">
          <div className="text-center mb-2">
            <img src="/src/assets/tree-fill.png" alt="탄소 배출 감소" className="w-12 h-12 mx-auto mb-2" />
            <h3 className="text-[18px] text-[#666666]">탄소 배출 감소</h3>
          </div>

          <p className="text-center font-bold text-xl text-[#333333]">2.5kg</p>
        </div>

        <div className="bg-[#F9F9F9] rounded-xl py-8 px-4 shadow-md">
          <div className="text-center mb-2">
            <img src="/src/assets/mdi_bread.png" alt="음식물 낭비 감소" className="w-12 h-12 mx-auto mb-2" />
            <h3 className="text-[18px] text-[#666666]">음식물 낭비 감소</h3>
          </div>
        ...
        <div className="bg-[#F9F9F9] rounded-xl py-8 px-4 shadow-md">
          <div className="text-center mb-2">
            ...
            <h3 className="text-[18px] text-[#666666]">주행거리 감소</h3>
          </div>
        ...
        <div className="bg-[#F9F9F9] rounded-xl py-8 px-4 shadow-md">
          <div className="text-center mb-2">
            ...
            <h3 className="text-[18px] text-[#666666]">샤워물 절약</h3>
          </div>
